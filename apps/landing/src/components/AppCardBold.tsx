...
export const AppCardBold: React.FC<AppCardBoldProps> = ({
  ...
  return (
    <div className="relative bg-gradient-to-br from-banorte-red to-[#C4001F] rounded-card shadow-[0_5px_15px_rgba(235,0,41,0.3)] p-6 md:p-8 transition-all duration-300 ease-in-out hover:shadow-[0_8px_20px_rgba(235,0,41,0.4)] hover:scale-105 animate-[fadeIn_0.5s_ease-in-out] overflow-hidden group">
      ...
      <div className="relative z-10 flex flex-col">
        ...
        <Button
          ...
          variant="secondary"
          className="bg-white text-banorte-red hover:bg-banorte-light font-bold"
        >
          Acceder Ahora
        </Button>
      </div>
