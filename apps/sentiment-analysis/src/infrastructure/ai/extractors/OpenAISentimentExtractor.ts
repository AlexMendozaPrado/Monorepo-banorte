import { SentimentAnalysisResult } from "../../../core/domain/value-objects/SentimentAnalysisExtended";
import { SentimentPromptBuilder } from "../prompts/SentimentPromptBuilder";
...
export class OpenAISentimentExtractor {
